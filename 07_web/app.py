...
⚠️ ข้อจำกัดตอนนี้ (ต้องบอกผู้ใช้เว็บให้ชัดเจน):
  - โมเดลเทรนจากคนจริงแค่ 12 คน (22 คลิป) LOSO macro-F1 = 0.640 ± 0.163 — ยังไม่แม่นยำพอสำหรับ
    การใช้งานจริงจัง เป็น demo ต้นแบบเทคนิคที่ทำถูกวิธี (แบ่ง train/test ตามคนจริง ไม่มี data leakage
    ข้ามฝั่ง, ตรวจ overfit/bias แล้ว — LOSO คือตัวเลขที่เชื่อถือได้ที่สุด เพราะวัดจากคนจริงทั้ง 12 คน
    ไม่ใช่แค่การแบ่ง train/test ครั้งเดียวซึ่งมีความแปรปรวนสูงมากเมื่อมีคนจริงน้อย)
